...
export const Tenants: CollectionConfig = {
  ...
  admin: {
    useAsTitle: 'name',
    defaultColumns: ['name', 'city', 'type', 'patron'],
  },
  fields: [
    {
      name: 'name',
    ...
    },
    {
      ...
      admin: {
        defaultColumns: ['title', 'periodStart', 'periodEnd'],
        description: {
          pl: 'Szablony nabożeństw przypisane do tej lokalizacji. Zarządzaj szablonami w kolekcji "Szablony nabożeństw".',
          en: 'Feast templates assigned to this location. Manage templates in the "Feast Templates" collection.'
        }
      }
    },
    {
