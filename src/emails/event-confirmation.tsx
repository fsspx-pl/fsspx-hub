...
const translations = {
  pl: {
    title: 'Potwierdź zapis na wydarzenie',
    greeting: 'Dzień dobry',
    instructions: 'Aby potwierdzić zapis na wydarzenie',
    confirmButton: 'Potwierdź zapis',
    manageButton: 'Zarządzaj zapisem',
    manageInstructions: 'Możesz również zarządzać swoim zapisem (edytować lub anulować) używając poniższego linku:',
    fallback: 'Jeśli przycisk nie działa, skopiuj i wklej poniższy link do przeglądarki:',
    disclaimer: 'Jeśli nie zapisywałeś się na to wydarzenie w',
    ignore: 'zignoruj tę wiadomość.',
  },
  en: {
    title: 'Confirm event signup',
    greeting: 'Hello',
    instructions: 'To confirm your signup for the event',
    confirmButton: 'Confirm signup',
    manageButton: 'Manage signup',
    manageInstructions: 'You can also manage your signup (edit or cancel) using the link below:',
    fallback: 'If the button does not work, copy and paste the following link into your browser:',
    disclaimer: 'If you did not sign up for this event at',
    ignore: 'please ignore this message.',
  },
};
        ...
        <Container className="mx-auto w-full max-w-[600px] p-0">
          ...
          >
            <Text style={{ fontSize: "16px", lineHeight: "1.6", color: "#333", marginBottom: "16px" }}>
              {t.greeting} <strong>{chapelInfo}</strong>!
            </Text>
            
            <Text style={{ fontSize: "16px", lineHeight: "1.6", color: "#333", marginBottom: "16px" }}>
              {t.instructions} <strong>{eventTitle}</strong>.
            </Text>
            ...
            <Text style={{ 
              ...
              {t.disclaimer} <strong>{chapelInfo}</strong>, {t.ignore}
            </Text>
          </Section>
